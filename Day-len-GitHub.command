#!/bin/bash
# Nháy đúp để đẩy code lên https://github.com/sonlovinbot/game-3d-mira-universe
# GitHub Actions sẽ tự build và xuất bản lên GitHub Pages.
cd "$(dirname "$0")"
REMOTE="https://github.com/sonlovinbot/game-3d-mira-universe.git"
...
if git push -u origin main; then
  echo ""
  echo "Xong. Xem tiến trình deploy: https://github.com/sonlovinbot/game-3d-mira-universe/actions"
  echo "Lần đầu: vào Settings → Pages → Source chọn \"GitHub Actions\"."
  echo "Link game: https://sonlovinbot.github.io/game-3d-mira-universe/"
  open "https://github.com/sonlovinbot/game-3d-mira-universe/actions"
else
  echo ""
